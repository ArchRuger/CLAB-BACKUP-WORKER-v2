> Historical guide for earlier releases. For 1.15.0, use [VM-CONNECTION.md](VM-CONNECTION.md)
> and [FRESH-VM-GUIDE.md](FRESH-VM-GUIDE.md). Their password setup replaces the SSH client key steps below.
> Build 1.15.0 from source; no new registry image is claimed by this delivery.
