...
- **Living guides** (`README.md`, `docs/*.md`, `deploy/*.md`, the app README,
  ...
  installer's closing line `Manager 1.30.29: running`. Those mentions are moved by
  the bump tool.
...
- **History files** may name any release: `docs/CHANGELOG.md`,
  ...
  `docs/archive/`, `docs/redesign/`, `docs/ui-review-001/` and `docs/multi-platform-restore/`
  (design notes, a per-release review log and a dated acceptance record). Each of the first three must lead with the current release.
