import{a as d}from"/static/lab-builder/assets/c-RJLSORTW.js";import{i as y}from"/static/lab-builder/assets/c-J7QBU4CT.js";import{b as M}from"/static/lab-builder/assets/c-5V5QO733.js";import{d as u}from"/static/lab-builder/assets/c-65TME3XB.js";function k(e,s,t,l,i,n){let o=t/2,h=l/2,x=i-e,g=n-s;if(x===0&&g===0)return{x:e,y:s};let a=Math.abs(x),c=Math.abs(g);if(a*h>c*o){let w=x>0?1:-1;return{x:e+w*o,y:s+g*o/a}}let r=g>0?1:-1;return{x:e+x*h/c,y:s+r*h}}function L(e,s){let t={x:e.x+e.width/2,y:e.y+e.height/2},l={x:s.x+s.width/2,y:s.y+s.height/2},i=k(t.x,t.y,e.width,e.height,l.x,l.y),n=k(l.x,l.y,s.width,s.height,t.x,t.y);return{sx:i.x,sy:i.y,tx:n.x,ty:n.y}}function H(e,s,t,l,i,n){let o=t-e,h=l-s,x=Math.sqrt(o*o+h*h);if(x===0)return{x:e,y:s};let g=Math.min(i/x,.4),a=n?Math.max(g,.15):g;if(n){let c=a,r=1-c;return{x:r*r*e+2*r*c*n.x+c*c*t,y:r*r*s+2*r*c*n.y+c*c*l}}return{x:e+o*a,y:s+h*a}}function j(e,s,t,l){let i=t-e,n=l-s;return Math.abs(i)>=Math.abs(n)?i>=0:n<=0}function $(e,s,t,l,i,n,o,h){if(n<=1)return null;let x=(e+t)/2,g=(s+l)/2,a=t-e,c=l-s,r=Math.sqrt(a*a+c*c);if(r===0)return null;let w=-c/r,m=a/r,p=(i-(n-1)/2)*h;return o||(p=-p),{x:x+w*p,y:g+m*p}}var F=new Map;function f(e,s){let t="";function l(i){return`
                <svg
            ...
            `}switch(e){case"pe":t=`
                <svg
                    ...
                    </svg>`;break;case"dcgw":t=l(s);break;case"leaf":t=l(s);break;case"bridge":case"switch":t=`
                    <svg
                        xmlns:xlink="http://www.w3.org/1999/xlink"
                        xmlns="http://www.w3.org/2000/svg"
                        xml:space="preserve"
                ...
                `;break;case"super-spine":t=`
                  ...
                  <svg
                    ...
                    `;break;default:d.warn(`Unknown nodeType: ${e}, using default PE SVG`),t=`
                <svg
                        xmlns:xlink="http://www.w3.org/1999/xlink"
                        xmlns="http://www.w3.org/2000/svg"
                        xml:space="preserve"
                    ...
                    </svg>`}return t}function V(e,s){let t=`${e}:${s}`,l=F.get(t);if(l!==void 0)return l;let i=f(e,s),n="data:image/svg+xml;utf8,"+encodeURIComponent(i);return F.set(t,n),n}var v=u(M(),1),S=y((0,v.jsx)("path",{d:"M19.14 12.94c.04-.3.06-.61.06-.94 0-.32-.02-.64-.07-.94l2.03-1.58c.18-.14.23-.41.12-.61l-1.92-3.32c-.12-.22-.37-.29-.59-.22l-2.39.96c-.5-.38-1.03-.7-1.62-.94l-.36-2.54c-.04-.24-.24-.41-.48-.41h-3.84c-.24 0-.43.17-.47.41l-.36 2.54c-.59.24-1.13.57-1.62.94l-2.39-.96c-.22-.08-.47 0-.59.22L2.74 8.87c-.12.21-.08.47.12.61l2.03 1.58c-.05.3-.09.63-.09.94s.02.64.07.94l-2.03 1.58c-.18.14-.23.41-.12.61l1.92 3.32c.12.22.37.29.59.22l2.39-.96c.5.38 1.03.7 1.62.94l.36 2.54c.05.24.24.41.48.41h3.84c.24 0 .44-.17.47-.41l.36-2.54c.59-.24 1.13-.56 1.62-.94l2.39.96c.22.08.47 0 .59-.22l1.92-3.32c.12-.22.07-.47-.12-.61zM12 15.6c-1.98 0-3.6-1.62-3.6-3.6s1.62-3.6 3.6-3.6 3.6 1.62 3.6 3.6-1.62 3.6-3.6 3.6"}),"Settings");export{k as a,L as b,H as c,j as d,$ as e,V as f,S as g};
