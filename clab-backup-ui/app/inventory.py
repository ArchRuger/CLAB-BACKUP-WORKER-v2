...
PLATFORMS = {
    ...
    # EOS: the running-config itself is a complete, loadable candidate; the companion artifact is the
    # same capture kept under its own name and hash so a restore never relabels backup text.
