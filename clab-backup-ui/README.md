...
Version 1.6.0 renames the application to Containerlab Node Manager, improves imported topology styling, adds right-click node actions, and names SuperPuTTY exports after the lab. See [node features and setup](NODE-FEATURES.md) for usage and upgrades.
